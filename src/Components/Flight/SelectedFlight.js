...
const SelectedFlight = () => {
  ...
  // console.log("single flightdetails", selectedFlight);
            ...
            <div className="row mt-5">
              ...
              <div className="col-lg-3 col-md-3 d-none d-lg-block d-md-block">
                ...
                <div className="left-bar">
                  ...
                  <div className="sub-title pl-3 pr-3 mt-2"> Total <span> {}</span> </div>
                  <div className="row">
                    <div className="col-lg-12 col-md-12 col-12">
                      <div className="sub-title for-tit-bor pl-3 pt-4 pb-2"> Additional Information </div>
                    </div>
                  </div>
                  <div className="sub-txt pl-3 pr-3 pb-2 pt-3"><strong>Fare Rules {item.origin} - {item.destination}</strong></div>
                ...
                {selectedFlight?.FlightDetails?.Outbound?.map((singleFlight, index) => (
                    <>
                      <div className="right-bar p-3 flight-detail">
                        ...
                        {selectedFlight?.FlightDetails?.Inbound.map((singleReturnFlight, index) => (
                            <>
                              <div className="sub-title mt-4"> <img src="assets/img/dep-icon.png" onError={({ currentTarget }) => {
